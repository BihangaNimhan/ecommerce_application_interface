            ...
            <div class="col-12 col-lg-12 bg">
                ...
                <div class="row">
                    <div class="col-7 col-lg-7 d0">
                        <h4 class="h4t">Android Products</h4>
                        <div class="row">
                            <div class="col-6 col-lg-6 top">
                                <form class="row g-3" action="androidprocess.php" method="POST" enctype="multipart/form-data">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="int" class="form-control" name="q" placeholder="0">
                                    </div>
                                    <div class="col-6">
                                        <label  class="form-label t">Unit price(LKR)</label>
                                        <input type="INT" class="form-control" name="p" placeholder="0.00" >
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="file" multiple="" accept="image" class="form-control" name="f" >
                                    </div><hr/>
                            ...
                            <div class="col-6 col-lg-6 d2 top">
                                <img src="img/Hot-Motion-Graphics-Trends-2020-770x513-removebg-preview.png" class="i1"/>
