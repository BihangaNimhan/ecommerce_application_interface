...
<head>
    <title>Apple product Registreation</title>
            ...
            <div class="col-12 col-lg-12 bg">
                ...
                <div class="row">
                    <div class="col-7 col-lg-7 d0">
                        <h4 class="h4t">Apple Products</h4>
                        <div class="row">
                            <div class="col-6 col-lg-6 top">
                                <form class="row g-3" action="appleprocess.php" method="POST" enctype="multipart/form-data">
                                    <div class="col-md-6">
                            ...
                            <div class="col-6 col-lg-6 d2 top">
                                <img src="img/6054dfac96e54865eb677f05da54fdbe-removebg-preview.png" class="i1"/>
